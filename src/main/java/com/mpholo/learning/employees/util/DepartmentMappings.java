...
public final class DepartmentMappings {


    public static final String EDIT_DEPARTMENTS="edit";
    public static final String ADD_DEPARTMENTS="add";
